            ...
            switch (_a.label) {
                case 0:
                    ...
                    if (!fs.existsSync(options.inputPath)) {
                        console.error("Error: Input file not found: ".concat(options.inputPath));
                        process.exit(1);
                    }
                ...
                case 1:
                    _a.trys.push([1, 3, , 4]);
                    return [4 /*yield*/, (0, video_utils_node_1.processVideoWithFilter)(options.inputPath, options.outputPath, options.blurRadius, options.sharpenStrength, options.sharpenMode, options.numIterations)];
                case 2:
                    _a.sent();
                    console.log('✓ Video processing complete!');
                    console.log("Output saved to: ".concat(options.outputPath));
                    return [3 /*break*/, 4];
                case 3:
                    error_1 = _a.sent();
